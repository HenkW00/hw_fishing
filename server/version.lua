...
local resourceName = "hw_fishing"

if Config.checkForUpdates then
    CreateThread(function()
        if GetCurrentResourceName() ~= "hw_fishing" then
            resourceName = "hw_fishing (" .. GetCurrentResourceName() .. ")"
        end
    end)

    CreateThread(function()
        while true do
            PerformHttpRequest("https://api.github.com/repos/HenkW00/hw_fishing/releases/latest", CheckVersion, "GET")
            Wait(3500000)
        end
    end)
    ...
    GetRepoInformations = function()
        ...
        PerformHttpRequest("https://api.github.com/repos/HenkW00/hw_fishing/releases/latest", function(err, response, headers)
            if err == 200 then
                ...
                repoURL = "https://github.com/HenkW00/hw_fishing"
